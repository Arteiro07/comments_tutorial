...
app.post("/posts/:id/comments", async (req, res) => {
	if (req.body.message === "" || req.body.message == null) {
		return res.send(app.httpErrors.badRequest("Comment was empty"));
	}
	...
	if (userId !== req.cookies.userId) {
		return res.send(
			app.httpErrors.unauthorized(
				"You are not the author of the comment you're trying to edit"
			)
		);
	}
...
app.delete("/posts/:postId/comments/:commentId", async (req, res) => {
	...
	if (userId !== req.cookies.userId) {
		return res.send(
			app.httpErrors.unauthorized(
				"You are not the author of the comment you're trying to delete"
			)
		);
	}
